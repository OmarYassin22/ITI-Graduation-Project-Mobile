    ...
    if (field) {
      Alert.alert(
        ...
        [
          {
            text: "Cancel",
            onPress: () => Alert.alert("Cancelled", "Your application has been canceled.", "error"),
            style: "cancel",
          },
          {
            text: "Submit",
            onPress: async () => {
              ...
              Alert.alert("Submitted", "Your application has been submitted.", [
                { text: "OK", onPress: () => navigation.navigate("BuyerScreen") },
              ]);
            },
          },
        ]
      ...
      Alert.alert("Error", "Please select a field", "error");
    }
  };
  ...
  <View style={styles.card}>
    {questions[field]?.map((q, i) => (
      <View key={i} style={styles.questionContainer}>
        <Text style={styles.question}>{q.questions}</Text>
        {q.answers.map((a, j) => (
          <View key={j} style={styles.answer}>
            <RadioButton
              value={j.toString()}
              status={answers[i] === j ? "checked" : "unchecked"}
              onPress={() => {
